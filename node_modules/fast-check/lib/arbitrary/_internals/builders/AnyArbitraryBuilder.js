...
function setOf(va, maxKeys, size) {
    return (0, Converters_1.convertFromNext)((0, Converters_1.convertToNext)((0, set_1.set)(va, { maxLength: maxKeys, size, compare: { type: 'SameValueZero' } })).map(ArrayToSet_1.arrayToSetMapper, ArrayToSet_1.arrayToSetUnmapper));
}
